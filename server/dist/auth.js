...
var githubPassport = function (passport) {
    passport.use(new GitHubStrategy({
        clientID: process.env.GITHUB_CLIENT_ID,
        clientSecret: process.env.GITHUB_CLIENT_SECRET,
        callbackURL: process.env.HOST + "/auth/github/callback",
    }, function (profile, done) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, user_1.User.findOne({ githubId: profile.id })];
                case 2:
                    user = _a.sent();
                    console.log('Searching through users...');
                    if (!user) return [3 /*break*/, 3];
                    done(null, user);
                    console.log('Signed in, since there is already an account for this user.');
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, new user_1.User({
                        githubId: profile.id,
